...
const NavBer = () => {
    ...
    const navItems = (
        <>
            <NavLink className={({ isActive }) => (isActive ? "active" : "default")} >Get Pro</NavLink>
            <NavLink className={({ isActive }) => (isActive ? "active" : "default")} >Movie</NavLink>
            <NavLink className={({ isActive }) => (isActive ? "active" : "default")} >Watch-List</NavLink>
            {
